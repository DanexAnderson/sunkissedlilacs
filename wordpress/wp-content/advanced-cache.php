...
if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-sunkissedlilacs.com.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-sunkissedlilacs.com.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-sunkissedlilacs.com.php');
}
