...
class Elementor {
    ...
    public function enqueue_scripts( $hook = '' ) {
        ...
        \wp_localize_script( 'templately-editor', 'TemplatelyAdmin', array(
            ...
            'is_admin' => is_admin(),
            'admin' => DB::get_option('_templately_connect_data', []),
            'post_id' => get_the_ID(),
            ...
            'cloud_activity' => DB::get_option( '_templately_cloud_last_activity', array( 'labels' => 'My Clouds', 'value' => 'clouds' ) ),
        ...
        if( ! defined( 'TEMPLATELY_SCRIPT' ) || ( defined('TEMPLATELY_SCRIPT') && ! TEMPLATELY_SCRIPT ) ) {
